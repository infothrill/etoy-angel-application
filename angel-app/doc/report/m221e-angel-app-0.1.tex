...
\vspace{10cm}
Following page: Visualization of the module import graph of the core (``maintainer'') process of the \textsc{Angel-Application}. This process negotiates inter-node communication, keeps track of resource replicas and verifies and replicates the resource tree.
...
\end{equation}
are still working. This formula is based on the assumption of spontaneous (uncorrelated), irreversible failure, similar to \emph{e.g.} radioactive decay. The corresponding differential form illustrates that the rate of decay is assumed to be proportional to the (time-dependent) existing population
\begin{equation}
